\documentclass[11pt,oneside,bibliography=totoc,abstracton]{scrreprt}
...
\usepackage{etoolbox}% Tools for changing commands
...
% Disable header for beginning and use fancy instead of plain
\fancyhead[LO,RE]{}
\fancyhead[LE,RO]{}
...
\newcommand{\datef}[1]{\ensuremath{#1}}
\newcommand{\figref}[1]{\textbf{Figure \ref{#1}}}
\newcommand{\tableref}[1]{\textbf{Table \ref{#1}}}
\newcommand{\progref}[1]{\textbf{Program \ref{#1}}}
...
\newcommand{\macromathtext}[1]{\macro{\ensuremath{\text{#1}}}}
...
\newcommand{\js}{\macrosc{JavaScript}}
...
\newcommand{\lexiSearch}{\macrosc{LexiSearch}}
\newcommand{\nns}{\macrosc{NNS}}
...
\newcommand{\bzipTwo}{\macrosc{BZIP2}}
\newcommand{\gzip}{\macrosc{GZIP}}
\newcommand{\xz}{\macrosc{XZ}}
\newcommand{\restApi}{\macrosc{REST-API}}
\newcommand{\api}{\macrosc{API}}
\newcommand{\http}{\macrosc{HTTP}}
\newcommand{\tnr}{\macrosc{TNR}}
\newcommand{\ch}{\macrosc{CH}}
\newcommand{\rtd}{\macrosc{RTD}}
\newcommand{\bellmanFord}{\macrosc{Bellman-Ford algorithm}}
\newcommand{\arcFlags}{\macrosc{Arc-Flags}}
\newcommand{\chase}{\macrosc{Chase}}
\newcommand{\raptor}{\macrosc{Raptor}}
...
\newcommand{\depTime}{\macromathsf{depTime}}
\newcommand{\modes}{\macromathsf{modes}}
\newcommand{\fromJ}{\macromathsf{from}}
\newcommand{\toJ}{\macromathsf{to}}

\newcommand{\uniModal}{\macromathtext{uni-modal}}
\newcommand{\multiModal}{\macromathtext{multi-modal}}
...
\renewcommand{\figurename}{Fig.}% Fig. instead of Figure when linking figures
\renewcommand{\bibname}{References}% References instead of Bibliography for literature
...
\begin{titlepage}
	...
	\date{September 11, 2018}% Fix a date
	\maketitle
...
\begin{abstract}
	...
	\vfill
	\parbox{4cm}{\hrule \strut \centering\footnotesize Place, Date} \hfill\parbox{4cm}{\hrule \strut \centering\footnotesize Signature}
\end{abstract}
\clearpage
...
\fancyhead[LO,RE]{\parbox{0.7\textwidth}{\textbf{\nouppercase{\rightmark}}}}
\fancyhead[LE,RO]{\textbf{Section \arabic{chapter}}}
\restoregeometry
