...
\chapter{Shortest path problem}\label{shortestPathProblem}
	For route planning, routes through a network must be optimized with regards to one or even many criteria.
	A common criterion is the \textit{travel time}. Others include cost, number of transfers or restrictions
