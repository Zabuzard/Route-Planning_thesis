...
\section{Nearest neighbor problem}\label{nearestNeighborProblem}
	...
	\begin{align*}
		...
		x_{11}	&= (10, 80).
	\end{align*}
	All points are element of the cartesian plane $\mathbb{R}$. The euclidean distance $d$ is chosen as metric on this set.
...
\subsection{Cover tree}
	\begin{mydef}\label{coverTree}
		...
		The root is placed at the greatest level, denoted by $k \in \mathbb{N}$.
